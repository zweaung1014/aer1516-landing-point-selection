...
from scipy.spatial.transform import Rotation as R #### EDITED: import tf_transformations
...
class CrazyflieServer(Node):
    ...
    def _log_pose_data_callback(self, timestamp, data, logconf, uri):
        ...
        q = R.from_euler('xyz', [roll, pitch, yaw]).as_quat() #### EDITED: q = tf_transformations.quaternion_from_euler(roll, pitch, yaw)
